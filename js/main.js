...
var endDate = "May 22, 2015 12:00:00";
...
$('.countdown.styled').countdown({
  ...
  render: function(data) {
    $(this.el).html("<div class='cd-days'>" + this.leadingZeros(data.days, 1) + " <span class='cd-white'>days</span></div><div class='cd-hours'>" + this.leadingZeros(data.hours, 1) + " <span class='cd-white'>hrs</span></div><div class='cd-mins'>" + this.leadingZeros(data.min, 1) + " <span class='cd-white'>min</span></div><div class='cd-secs'>" + this.leadingZeros(data.sec, 2) + " <span class='cd-white'>seconds</span></div>");
  }
});
