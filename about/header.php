...
<head>
	...
	<meta name="description" content="Non-profit athletics club located in the heart of Montreal since the 1980s. We provide affordable and accessible facilities, training and competition for basketball, badminton and golf"/>
	...
	<!-- Hank's stylesheets -->
	<link rel="stylesheet" id="execSlide" href="execSlides.css" type="text/css" media=""/>
					...
					<nav class="nav megamenu_container wrapper">
						<ul id="nav" class="centered-menu megamenu">
							...
							<li class="nav-parent">
								...
								<a href="../about/index.php">About Us &nbsp; <em class="fa">&#xf107;</em></a>
