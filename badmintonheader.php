...
<head>
	...
	<meta name="description" content="Join us for affordable recreational drop-in badminton every Sunday!"/>
					...
					<nav class="nav megamenu_container wrapper">
						<ul id="nav" class="centered-menu megamenu">
							...
							<li class="nav-parent">
								...
								<ul>
									<li><a href="../basketball/">Events</a></li> <!-- UPDATE THIS LINK -->
							...
							<li><a href="../donate.php">DONATE <i class="fa fa-money"></i></a></li>
